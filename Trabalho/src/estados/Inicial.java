...
class Inicial implements Estado {
    ...
    public Estado proximoEstado(char c) {
        switch (c) {
            case '{': return Estados.AbreChave;
            case '}': return Estados.FechaChave;
            case '(': return Estados.AbreParentese;
            case ')': return Estados.FechaParentese;
            case '[': return Estados.AbreColchete;
            case ']': return Estados.FechaColchete;
            case '<': return Estados.MenorQue;
            ...
            case '&': return Estados.EComercial;
            case '+': return Estados.Soma;
            case '-': return Estados.Subtracao;
            case '*': return Estados.Multiplicacao;
            case '/': return Estados.Divisao;
            case '%': return Estados.Resto;
            case '\'': return Estados.AspaSimples;
