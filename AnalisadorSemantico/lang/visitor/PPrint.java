...
public class PPrint extends NodeVisitor{
  ...
  public  void visit(NullLit e){ putStr("null"); }
  ...
  public  void visit(IntLit e){putStr(e.getValue()+ "");}
  public  void visit(CharLit e){
     if(e.getValue() == '\n'){putStr("'\\n'"); return; }
     if(e.getValue() == '\b'){putStr("'\\b'"); return; }
     if(e.getValue() == '\t'){putStr("'\\t'"); return; }
     if(e.getValue() == '\r'){putStr("'\\r'"); return; }
     if(e.getValue() == '\\'){putStr("'\\\\'"); return; }
     putStr(e.getValue() + "");
  }
  public  void visit(FloatLit e){ putStr(e.getValue()+ "");}
  ...
  public  void visit(Var e){ putStr(e.getVarName()); }  
  ...
  // Types 
  public  void visit(TyVoid ty){ putStr("Void");    }
  public  void visit(TyInt ty){ putStr("Int");      }
  public  void visit(TyFloat ty){ putStr("Float");  }
  public  void visit(TyChar ty){ putStr("Char");    }
  public  void visit(TyBool ty){ putStr("Bool");    }
  public  void visit(TyID ty){ putStr(ty.getTyID()); }
